...
int main() 
{
   ...
   printf("Shell Sort took %f seconds to execute \n", ss[6]);
   sname[6] = "Shell Sort";
   ss[7] = countingSort(arr, SIZE);
   printf("Counting Sort took %f seconds to execute \n", ss[7]);
   sname[7] = "Counting Sort";
   ...
   printf("\nSorted Times\n");
   for(int i = 0; i < NUM_SORTS; i++) {
      printf("%d %c Sort took %f seconds to execute \n",i,sname[i], ss[i]);
   }
